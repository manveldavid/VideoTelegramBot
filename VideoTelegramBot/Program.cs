namespace VideoTelegramBot
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var baseUrl = Environment.GetEnvironmentVariable("PUBLIC_URL") ?? "http://127.0.0.1:8000/";
            var baseSecureUrl = Environment.GetEnvironmentVariable("PUBLIC_URL_SECURE") ?? "https://127.0.0.1:8001/";
